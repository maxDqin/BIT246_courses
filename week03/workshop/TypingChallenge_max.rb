...
class Test
  ...
  def display_instructions
    ...
    When it comes to grading, A for nine or ten correctly typed sentences, a B for eight,
    a C for seven, a D for six, and an F for five or fewer.
    \n\n\n\n\n\n\n\n\n
  ...
  def determine_grade
    ...
    when ($noRight.between?(9, 10))
      puts "You got A."
    when ($noRight.between?(8, 8))
      puts "You got B."
    when ($noRight.between?(7, 7))
      puts "You got C."
    when ($noRight.between?(6, 6))
      puts "You got D."
    else
      puts "You got F."
    end
...
if answer == "n"  #See if the player elected not to play
  ...
  Typing_Test.present_test "challenge no.6 by Max"
  Typing_Test.present_test "challenge no.7 by Max"
  Typing_Test.present_test "challenge no.8 by Max"
  Typing_Test.present_test "challenge no.9 by Max"
  Typing_Test.present_test "challenge no.10 by Max"
