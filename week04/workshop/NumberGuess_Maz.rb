...
class Game
  ...
  def generate_number
    ...
    #return randomNo = 1 + rand(1000) # Task 2
    $totalNoOfGuesses = $totalNoOfGuesses + 1 # Task 1
    return 1
...
SQ.display_credits
puts "number of games is: " + $gameCount.to_s
puts "the average number of guesses per game is: " + $avgNoOfGuesses.to_s
