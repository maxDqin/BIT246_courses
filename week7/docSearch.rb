...
class SeachingClass # Class Name
  ...
  def initialize(path, term)# constructor
  ...
  def check
    ...
    # If the directory exist it will creates an array with matxhing file extensions
  ...
  def searchForContent # Search – Main logic
    ...
    @arrayFiles.each do |file|
      ...
      if res_hash.size>0 then
        ...
        file_paragraphs.each do |line|#Moves to each line
        line.split.each do |word|#Moves to each word
